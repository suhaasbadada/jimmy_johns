        ...
        <DefaultLayout>
            <div className="mx-auto max-w-4x">
                <section className="border-l-8 border-gray-500 flex flex-col items-center justify-center bg-slate-100 rounded-r-3xl shadow-xl">
                    ...
                    <Spacer y={3} />
                    <h2>Spills per Year in Indiana</h2>
                    <div className="h-80 w-full">
                        <SpillLine />
                        <p className="text-center bg-white w-fit mx-auto m-2 px-1 rounded-md"><span className="italic">Figure 1:</span> This figure shows the spills reported in Indiana for each year from 2010 to 2024.</p>
                    </div>
                </section>
                ...
                <section className="border-l-8 border-gray-500 flex flex-col items-center justify-center bg-slate-100 rounded-r-3xl shadow-xl">
                    ...
                    <div className="h-[54rem] w-full">
                        <CleanupBar />
                        <p className="text-center bg-white w-fit m-2 px-1 mt-4 rounded-md mx-auto"><span className="italic">Figure 2:</span> This figure shows the detected toxins from 2010 to 2024.</p>
                    </div>
                    <Spacer y={3} />
                </section>
